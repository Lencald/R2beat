...
$(function() {
	...
	$.fn.jQBanner = function(defaults){
		...
		if (config.isStartDelay=="Y" && isIEChk==true) {
			/* 스타트 딜레이 처리 */
			if (f_nBnrCnt>=0 && f_nBnrCnt<=1) {
				setTimeout( function(){jsBanInit(config)}, f_nBnrCnt*100);
			} else if (f_nBnrCnt>1 && f_nBnrCnt<=6) {
...
/*
     FILE ARCHIVED ON 18:35:56 Feb 10, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:01:57 Jul 22, 2022.
...
/*
playback timings (ms):
  captures_list: 112.107
  exclusion.robots: 0.281
  exclusion.robots.policy: 0.27
  RedisCDXSource: 2.862
  esindex: 0.009
  LoadShardBlock: 80.113 (3)
  PetaboxLoader3.datanode: 71.712 (5)
  CDXLines.iter: 25.241 (3)
  PetaboxLoader3.resolve: 239.095 (3)
  load_resource: 269.061 (2)
*/